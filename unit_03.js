...
function f3() {
    const val1 = +document.querySelector(".i-31").value
    const val2 = +document.querySelector(".i-32").value
    const out = document.querySelector(".out-3")
    if (val1 > val2) {
        out.textContent = val1
    } else {
        out.textContent = val2
    }
}
...
function f7() {
    const val1 = document.querySelector(".i-71").value
    const val2 = document.querySelector(".i-72").value
...
function f8() {
    const val = document.querySelector(".s-8").value
...
function f14() {
    const val1 = +document.querySelector(".i-141").value
    const val2 = +document.querySelector(".i-142").value
    const select = document.querySelector(".s-143").value
    const out = document.querySelector(".out-14")
    if (select === "+") {
        out.innerHTML = val1 + val2
    } else if (select === "-") {
        out.innerHTML = val1 - val2
    } else if (select === "*") {
        out.innerHTML = val1 * val2
